...
def eps_neighbor(a, b, eps):
    """
    check whether point a and are within area of eps
    """
    return dist(a, b) < eps

def region_query(data, pointId, eps):
    """
    find the points that are within the area of eps of pointId
    """
...
def expand_cluster(data, clusterResult, pointId, clusterId, eps, minPts):
    ...
    输出：能否成功分类
    whether it can be clustered
    """
    seeds = region_query(data, pointId, eps)
    if len(seeds) < minPts:                         # noisy points
